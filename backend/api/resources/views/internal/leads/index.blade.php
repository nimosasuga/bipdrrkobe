...
<head>
    ...
    <style>
        *{box-sizing:border-box}body{margin:0;background:#f7f7f3;color:#0a0a0a;font-family:Inter,Arial,sans-serif}.shell{min-height:100vh}.top{background:#0a0a0a;color:#fff}.top-inner{max-width:1240px;margin:auto;padding:18px 24px;display:flex;align-items:center;justify-content:space-between;gap:18px}.brand{font-weight:900;font-size:24px;letter-spacing:-.04em}.badge{margin-left:8px;background:#ffcc00;color:#000;border-radius:999px;padding:4px 8px;font-size:10px;font-weight:900}.user{font-size:12px;color:#d4d4d8}.top-actions{display:flex;align-items:center;gap:10px}.top-link,.logout{border:1px solid #3f3f46;background:transparent;color:#fff;border-radius:999px;padding:9px 14px;font-weight:800;font-size:12px;text-decoration:none;cursor:pointer}.main{max-width:1240px;margin:auto;padding:36px 24px 56px}.eyebrow{font:700 11px/1.5 monospace;letter-spacing:.12em;color:#71717a}.title{margin:6px 0 8px;font-size:36px;font-weight:900;letter-spacing:-.04em}.muted{margin:0;color:#71717a;font-size:14px;line-height:1.7}.filters{margin-top:26px;background:#fff;border:1px solid #e4e4e7;border-radius:22px;padding:18px}.filter-grid{display:grid;grid-template-columns:minmax(220px,1.5fr) repeat(3,minmax(155px,.7fr)) auto;gap:10px}.field label{display:block;margin-bottom:6px;font:800 9px/1.4 monospace;letter-spacing:.08em;color:#71717a}.input,.select{width:100%;height:42px;border:1px solid #d4d4d8;border-radius:12px;background:#fff;padding:0 12px;font-size:13px;color:#0a0a0a;outline:none}.input:focus,.select:focus{border-color:#0a0a0a}.submit{align-self:end;height:42px;border:0;border-radius:12px;background:#0a0a0a;color:#fff;padding:0 18px;font-weight:900;cursor:pointer}.quick{display:flex;flex-wrap:wrap;gap:8px;margin-top:14px}.chip{display:inline-flex;align-items:center;gap:6px;border:1px solid #e4e4e7;background:#fff;color:#0a0a0a;border-radius:999px;padding:8px 11px;font-size:10px;font-weight:900;text-decoration:none}.chip.active{background:#0a0a0a;color:#fff;border-color:#0a0a0a}.chip.hot{border-color:#fecaca}.chip.warm{border-color:#fde68a}.chip.overdue{border-color:#fca5a5;color:#991b1b}.chip.today{border-color:#fde68a}.chip.reset{color:#71717a}.summary{margin:24px 0 12px;display:flex;align-items:center;justify-content:space-between;gap:14px}.summary strong{font-size:17px}.summary span{color:#a1a1aa;font-size:11px}.cards{display:grid;gap:12px}.card{background:#fff;border:1px solid #e4e4e7;border-radius:20px;padding:18px;display:grid;grid-template-columns:1.2fr .75fr .7fr .65fr .8fr auto;gap:16px;align-items:center}.company{font-size:15px;font-weight:900}.site,.small{margin-top:4px;color:#71717a;font-size:11px;line-height:1.45}.label{font:800 9px/1.4 monospace;letter-spacing:.08em;color:#a1a1aa}.value{margin-top:5px;font-size:12px;font-weight:800}.priority,.status,.followup{display:inline-flex;border-radius:999px;padding:6px 9px;font-size:9px;font-weight:900;letter-spacing:.05em;white-space:nowrap}.priority.hot{background:#fee2e2;color:#991b1b}.priority.warm{background:#fef3c7;color:#92400e}.priority.monitor{background:#e4e4e7;color:#3f3f46}.priority.pending{background:#f4f4f5;color:#71717a}.status{background:#0a0a0a;color:#fff}.followup.overdue{background:#fee2e2;color:#991b1b}.followup.today{background:#fef3c7;color:#92400e}.followup.scheduled{background:#ecfdf5;color:#065f46}.followup.unscheduled{background:#f4f4f5;color:#71717a}.score{font-size:22px;font-weight:900}.open{display:inline-flex;border-radius:999px;background:#ffcc00;color:#000;padding:9px 12px;font-size:10px;font-weight:900;text-decoration:none;white-space:nowrap}.open:hover{background:#f5c000}.empty{background:#fff;border:1px dashed #d4d4d8;border-radius:20px;padding:36px;text-align:center;color:#a1a1aa}.pager{margin-top:18px;display:flex;align-items:center;justify-content:space-between;gap:12px}.pager-info{font-size:11px;color:#71717a}.pager-actions{display:flex;gap:8px}.pager-link{display:inline-flex;border:1px solid #d4d4d8;background:#fff;color:#0a0a0a;border-radius:999px;padding:8px 12px;font-size:10px;font-weight:900;text-decoration:none}.pager-link.disabled{pointer-events:none;color:#a1a1aa;background:#f4f4f5}.footer{margin-top:30px;border-top:1px solid #e4e4e7;padding-top:18px;font-size:11px;color:#a1a1aa}.role{text-transform:uppercase}@media(max-width:1050px){.filter-grid{grid-template-columns:1fr 1fr}.card{grid-template-columns:1fr 1fr}.card .action{grid-column:1/-1}}@media(max-width:720px){.top-inner{align-items:flex-start;flex-direction:column}.top-actions{width:100%;justify-content:space-between}.main{padding:28px 16px 44px}.title{font-size:30px}.filter-grid{grid-template-columns:1fr}.card{grid-template-columns:1fr;gap:12px}.card .action{grid-column:auto}.open{justify-content:center;width:100%}.summary,.pager{align-items:flex-start;flex-direction:column}.pager-actions{width:100%}.pager-link{flex:1;justify-content:center}}
    </style>
</head>
<body>
<div class="shell">
    ...
    <main class="main">
        <div class="eyebrow">PHASE 8 · FOLLOW-UP CONTROL</div>
        <h1 class="title">All Leads</h1>
        <p class="muted">Filter prioritas, status sales, dan jadwal follow-up. Waktu follow-up menggunakan zona Asia/Jakarta.</p>
        ...
        <section class="filters">
                ...
                <div class="filter-grid">
                    ...
                    <div class="field">
                        ...
                        <select class="select" id="priority" name="priority">
                            ...
                            @foreach($priorities as $option)<option value="{{ $option }}" @selected($priority === $option)>{{ strtoupper($option) }}</option>@endforeach
                        </select>
                    </div>
                    <div class="field">
                        ...
                        <select class="select" id="status" name="status">
                            ...
                            @foreach($statuses as $option)<option value="{{ $option }}" @selected($status === $option)>{{ strtoupper(str_replace('_', ' ', $option)) }}</option>@endforeach
                        </select>
                    </div>
                    <div class="field">
                        ...
                        <select class="select" id="followup" name="followup">
                            ...
                            <option value="overdue" @selected($followUp === 'overdue')>OVERDUE</option>
                            <option value="today" @selected($followUp === 'today')>DUE TODAY</option>
                            <option value="unscheduled" @selected($followUp === 'unscheduled')>UNSCHEDULED</option>
                        </select>
                    </div>
            ...
            <div class="quick">
                <a class="chip reset {{ $priority === '' && $status === '' && $followUp === '' && $search === '' ? 'active' : '' }}" href="{{ route('internal.leads.index') }}">SEMUA</a>
                <a class="chip overdue {{ $followUp === 'overdue' ? 'active' : '' }}" href="{{ route('internal.leads.index', ['followup' => 'overdue']) }}">OVERDUE</a>
                <a class="chip today {{ $followUp === 'today' ? 'active' : '' }}" href="{{ route('internal.leads.index', ['followup' => 'today']) }}">DUE TODAY</a>
                <a class="chip {{ $followUp === 'unscheduled' ? 'active' : '' }}" href="{{ route('internal.leads.index', ['followup' => 'unscheduled']) }}">UNSCHEDULED</a>
                ...
                @foreach($statuses as $option)<a class="chip {{ $status === $option ? 'active' : '' }}" href="{{ route('internal.leads.index', ['status' => $option]) }}">{{ strtoupper(str_replace('_', ' ', $option)) }}</a>@endforeach
            </div>
        </section>
            ...
            <section class="cards">
                @foreach($leads as $lead)
                    @php
                        ...
                        $isClosed = in_array($leadStatus, ['won', 'lost'], true);
                    ...
                    <article class="card">
                        <div>
                            ...
                            <div class="small">{{ $lead->whatsapp }} · {{ optional($lead->created_at)->timezone('Asia/Jakarta')->format('d M Y H:i') }}</div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div class="value"><span class="followup {{ $followClass }}">{{ $followLabel }}</span></div>
                            <div class="small">{{ $nextLocal ? $nextLocal->format('d M Y H:i') : ($isClosed ? 'Pipeline ditutup' : 'Belum dijadwalkan') }}</div>
                        </div>
        ...
        <div class="footer">DRRKOBE · Internal Sales Intelligence · Follow-up controlled</div>
    </main>
</div>
</body>
</html>
