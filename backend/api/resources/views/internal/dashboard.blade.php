    ...
    <main class="main">
        ...
        <section class="section">
            <div class="section-head">
                ...
                <div class="section-note">Status follow-up aktual dari seluruh lead internal</div>
            </div>
            ...
            <div class="pipeline">
                @foreach($pipelineItems as [$label, $class, $value, $caption])
                    <article class="pipeline-card {{ $class }}">
