    ...
    <main class="main">
        ...
        <section class="section">
            <div class="section-head">
                ...
                <div class="section-note">Klik Open untuk detail diagnosis dan sales follow-up</div>
            </div>
