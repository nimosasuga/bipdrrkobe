...
<main class="main">
    <div class="eyebrow">BIP → ASSESSMENT → LEAD → DEAL</div>
    <h1 class="title">Conversion Dashboard</h1>
    <p class="muted">Fokus pada alur sederhana: user menjalankan assessment, masuk sebagai lead, Anda follow-up, lalu Deal atau Lost.</p>
    ...
    <div class="note"><strong>ADS tracking belum dihitung di halaman ini.</strong> Tahap berikutnya akan menambahkan sumber campaign sehingga alurnya lengkap: ADS → USER → ASSESSMENT → LEAD → DEAL.</div>
